...
#define STRING_CONFIG_H_AUTHOR "(Ray Forbes SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME STRING_DISTRIBUTION_DATE " " __TIME__ " Ender-3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 726 }
